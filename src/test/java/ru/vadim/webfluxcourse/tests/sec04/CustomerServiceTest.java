package ru.vadim.webfluxcourse.tests.sec04;
...
public class CustomerServiceTest {
    ...
    void customerNotFound() {
        this.webTestClient
                ...
                .expectBody()
                .jsonPath("$.detail").isEqualTo("Customer with [id=120] is not found");
        ...
        this.webTestClient
                ...
                .exchange()
                .expectStatus().is4xxClientError()
                .expectBody().jsonPath("$.detail").isEqualTo("Customer with [id=120] is not found");
    ...
    @Test
    void invalidField() {
        var dto = new CustomerDto(null, null, "appolon@gmail.com");
        this.webTestClient
                .post()
                .uri("/customers")
                .bodyValue(dto)
        ...
        var missingEmail = new CustomerDto(null, "nastya", null);
        this.webTestClient
                .post()
                .uri("/customers")
        ...
        var invalidEmail = new CustomerDto(null, "nastya", "apppolo");
        this.webTestClient
                .put()
                .uri("/customers/10")
